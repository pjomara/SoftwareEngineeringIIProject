...
def nutr_write(tot_calories, tot_protein, tot_fat, tot_carb, tot_sodium, tot_sugar, servSize):
    ...
    print (html2text.html2text("<p style=width: 300px; display: table;> <span style=display: table-cell; border-bottom: 2px solid black;></span>"), file=recipe)

    print (html2text.html2text("<h3>Nutrition Facts</h3>"), file=recipe)

    print (html2text.html2text("<h3>Valeur nutritive</h3>"), file=recipe)

    print (html2text.html2text("<p style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 3px solid black;>Per servSize g / par servsize g</span></p>"), file=recipe)

    print (html2text.html2text("<h6 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 1px solid black;> Teneur&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;% valeur quotidienne*</span></h6>"), file=recipe)

    print (html2text.html2text("<h5 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 1px solid black;>Calories/Calories tot_calories </h5></span>"), file=recipe)


    print (html2text.html2text("<h5 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 1px solid black;>Fat/Lipides tot_fat g </span></h5>"), file=recipe)

    print (html2text.html2text("<h5 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 1px solid black;>Sodium/Sodium tot_sodium mg</span></h5>"), file=recipe)

    print (html2text.html2text("<h5 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 1px solid black;>Carbohydrate/Glucides tot_carb g</span></h5>"), file=recipe)

    print (html2text.html2text("<h6 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 1px solid black;>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sugar/Sucres tot_sugar g</span></h6>"), file=recipe)

    print (html2text.html2text("<h5 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 3px solid black;>Protein/Protéines tot_protein g</span></h5>"), file=recipe)

    print (html2text.html2text("<h5>*Pourcentage des valeurs quotidiennes </h5>"), file=recipe)

    print (html2text.html2text("<h5 style=width: 300px; display: table;><span style=display: table-cell; border-bottom: 2px solid black;> sur un régime de 2,000 calories.</span></h5>"), file=recipe)
